    ...
    <section className="hero" id="home" ref={heroRef}>
      <div className="hero-content">
        ...
        <div className="hero-socials">
          <a href="mailto:kavishedenis55@gmail.com" className="social-btn" style={{ '--hover-color': accentColor } as React.CSSProperties}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
              <polyline points="22,6 12,13 2,6"/>
            </svg>
          </a>
          <a href="https://wa.me/255746965913" className="social-btn" style={{ '--hover-color': accentColor } as React.CSSProperties}>
